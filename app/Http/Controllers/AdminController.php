...
class AdminController extends Controller
{
    ...
    public function createTag(CreateTagRequest $request)
    {
        ...
        $tag = Tag::register(
            ...
            function () {
                // Tag creation failed
                return redirect()->route('admin.tags')->with('error', 'Tag creation failed. Please try again.');
            }
        );
    ...
    public function updateTag(Request $request, Tag $tag)
    {
        ...
        return $tag->updater(
            ...
            function () {
                // tag update failed
                return redirect()->route('admin.tags')->with('error', 'Tag update failed. Please try again.');
            }
        );
    }
    ...
    public function deleteTag(Tag $tag)
    {
        ...
        if ($tag->deleteTag()) {
            ...
            // Tag deletion failed
            return redirect()->route('admin.tags')->with('error', 'Tag deletion failed. Please try again.');
        }
    }
}
